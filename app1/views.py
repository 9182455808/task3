...
global k 
k= 'C:/Users/vinod/OneDrive/Desktop/vin/website_1/bac1.jpg/'
...
def search(request):
    if request.method == "POST":
        ...
        if closest_name:
            ...
            matched_items += items.filter(name__iexact=matched_name)  
    
        if closest_city:
            matched_city = closest_city[0]
            matched_items += items.filter(address__iexact=matched_city) 
